...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                <a href="@salary_url@" class="card border-bottom-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Salario Ordinario</div>
            ...
            <div class="col-md-6">
                <a href="@iggs_url@" class="card border-bottom-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">IGGS</div>
                                <small class="mb-0 font-weight-bold text-primary">ir al m&oacute;dulo <i class="fas fa-caret-right"></i></small>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-md-6">
                <a href="@worksheet_url@" class="card border-bottom-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Generaci&oacute;n de Planillas</div>
                                <small class="mb-0 font-weight-bold text-primary">ir al m&oacute;dulo <i class="fas fa-caret-right"></i></small>
                            </div>
                            <div class="col-auto">
