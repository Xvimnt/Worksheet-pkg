# -*- tab-width: 4 -*-
# /packages/ctrl-categories/www/add-edit.tcl
ad_page_contract {
        ...
        @cvs-id                 $Id: add-edit.tcl,v 1.2 2005/01/06 21:10:48 jwang1 Exp $
} {
...
ad_form -name add_edit -form {
        ...
        {alt_code:text,optional                         {label "Alt Code:"}     }
        {activity_category:text,optional                {label "Activity Category:"}     }
  ...
  -on_request {
        ...
        db_transaction {
                if {![exists_and_not_null parent_category_id]} {
                    ...
                    set category_id [ctrl_category::new -parent_category_id "" \
                            -name $name \
                            -plural $plural \
                       ...
                       set category_id [ctrl_category::new -parent_category_id $parent_category_id \
                            -name $name \
                            -plural $plural \
                            -description $description \
                            -enabled_p $enabled_p \
        ...
        if {[exists_and_not_null error_p]} {
                ad_return_complaint 1 "
                        ...
                        There may already be a category with that name and parent-category. -- $errmsg
                "
                ad_script_abort
        }
} -edit_data {
    permission::require_permission -object_id $category_id -privilege "write"
    ctrl_category::edit -category_id $category_id\
